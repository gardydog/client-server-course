...
class GalleryHorisontalView: UIView {     //@IBDesignable перед классом может тупить, удаляй при необходимости
    ...
    private func loadFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "GalleryHorizontView", bundle: bundle)
    ...
    func setImages(images: [UIImage?]) {
        ...
        if self.images.count > 0 {
            self.mainImageView.image = self.images.first as? UIImage
        }
